...
import aboutThumb from "@/assets/img/demo3.jpg";
...
const tab_content: JSX.Element[] = [
  <>
    ...
    adipiscingem neque sed imquam nunullam quis ante. Etiam sit amet orci.
  </>,
  <>
    Etiam sit amet orci. Maecenas tempus, tellus eget condime honcus sem quam
    semper libero sit amet adipiscingem neque sed imquam nunullam quis ante.
  </>,
];
        ...
        <div className="row">
          ...
          <div className="col-lg-6 align-self-center">
            <div className="section-title px-lg-5 mb-0">
              ...
              <p className="content-strong mt-2">
                Duis leo. Sed fringilla mauris siamet nibh. odales sagittis
                magna. Sed consequat
              </p>
              <ul
                className="nav nav-tabs tab-button-style mt-4"
                id="myTab"
                role="tablist"
              >
