                ...
                <div key={item.id} className="single-blog-inner">
                    ...
                    <div className="thumb">
                      ...
                      {item.video_btn && (
                        <a
                          ...
                          className="video-play-btn video-play-btn-base"
                  ...
                  {item.carousel && (
                    <div className="slider-control-round blog-slider">
                      {/* <Slider
                        {...setting}
                        ref={sliderRef}
                        className="owl-carousel blog-thumb-slider"
                      >
                  ...
                  <div className="details">
                    ...
                    <ul className="blog-meta">
                      ...
                      <li>
                        <i className="far fa-comment-dots"></i> {item.comment}{" "}
                        Comment
                      </li>
                      <li>
                        <i className="far fa-folder-open"></i> It Solution
                      </li>
                    </ul>
                    <p>{item.desc}</p>
                    <Link
